...
import { SmileyRatingComponent } from 'app/entities/smiley-rating/smiley-rating.component';
...
describe('Component Tests', () => {
  describe('SmileyRating Management Component', () => {
    let comp: SmileyRatingComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(SmileyRatingComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.smileyRatings && comp.smileyRatings[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
